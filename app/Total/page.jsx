...
const Total = () => {
  return (
    <div className="grid grid-cols-3 gap-3 h-full p-3">
      <CardData title1="Bounce" title2="Previous" value1={'45%'} value2={'50%'} icon="/frame-1.svg"/>
      <CardData title1="Eng. time" title2="Previous" value1={'20m'} value2={'20m'} icon="/frame-2.svg" />
      <CardData title1="Clicks" title2="Previous" value1={8} value2={15} icon="/frame-3.svg" />
    </div>
  );
};
