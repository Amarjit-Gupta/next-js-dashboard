...
const Total = () => {
  return (
    <div className="grid grid-cols-3 gap-3 h-full p-3">
      <CardData title1="Bounce" title2=" month" value1={'45%'} value2={'50%'} icon="/frame-1.svg"/>
      <CardData title1="Eng. time" title2=" month" value1={'20m'} value2={'20m'} icon="/frame-2.svg" />
      <CardData title1="Clicks" title2=" month" value1={8} value2={15} icon="/frame-3.svg" />
    </div>
  );
};
  ...
  return (
    <div className="bg-gray-100 shadow-xs rounded-lg p-2 flex flex-col justify-around items-center">
      ...
      <div className="text-center border">
        ...
        <p className="text-xs lg:text-2xl font-medium lg:font-bold">{value1}</p>
      </div>

      {/* Second metric */}
      <div className="text-center border">
        <p className="text-gray-500 font-medium text-xs">{title2}:</p>
        <p className="text-xs lg:text-2xl font-medium lg:font-bold">{value2}</p>
      </div>
    </div>
  );
};